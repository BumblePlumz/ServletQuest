...
<div class="container">
      <form class="form-signin" method="POST" action="register">
        ...
        <input id="inputFirstName" name="firstname" class="form-control" placeholder="firstname" required autofocus="" type="text">
        
        <label for="inputLastName" class="sr-only">Lastname</label>
        <input id="inputLastName" name="lastname" class="form-control" placeholder="lastname" required type="text">
        ...
        <input id="inputPasswordConfirm" name="pwdConfirm" class="form-control" placeholder="confirm password" required type="password">
